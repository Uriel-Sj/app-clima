              ...
              <div className="flex justify-center bg-blue-400 rounded-t-lg ">
                ...
                <section className="flex justify-between content-center rounded mx-6 my-4 py-4 px-4 bg-green-300"> 
                    ...
                    <div className="flex-col w-16">
                        ...
                        <h3 className="text-base text-black">{humidity}</h3> 
                    </div>
                    <div className="flex-col w-16">
                        <img className="max-w-3/4 max-h-3/4 inline" src={speedd} alt="description"/>
                        <h3 className="text-base text-black">{Math.trunc(speed)}km</h3>
                    </div>
                </section>
                <Link to={`${cityName}`}>
                    <button className="rounded border p-2 hover:bg-whiteAplha focus:bg-whiteAplha text-white bg-negro">see more</button>
                </Link> 
